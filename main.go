...
func main() {
	config := &kafka.ConfigMap{"bootstrap.servers": "localhost", "group.id": "ronaldo-v1", "enable.auto.commit": false,
		"partition.assignment.strategy": "cooperative-sticky", "auto.offset.reset": "earliest"}
